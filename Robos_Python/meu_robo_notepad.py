...
window = app.SemTituloBlocoDeNotas # Lembrando que depois do app. vem o nome do título do aplicativo sem espaços e traços
window.set_focus()

#window.print_control_identifiers() # Para ver os identificadores dos elementos do aplicativo 

textEditor = window.child_window(title="Editor de Texto", auto_id="15", control_type="Edit").wrapper_object()
textEditor.type_keys("Hello, World! How are you, guys?", with_spaces = True) # É necessário colocar with_spaces = True para ser digitado os espaços
